...
for the students I’m working with.

## Usage

**sanbdox** analyses rely on the quarto documents that can be run with R
and associated environment defined with [renv](#0).

## Project

**sanbdox** includes many subprojects, each with their own folder and
documentation. Please explore them to understand how they work. However,
